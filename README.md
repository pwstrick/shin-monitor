# [shin-monitor](https://github.com/pwstrick/shin-monitor) [![license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/pwstrick/shin-monitor/blob/master/LICENSE) [![npm](https://img.shields.io/badge/npm-1.3.0-orange.svg)](https://www.npmjs.com/package/shin-monitor)
...
```html
<script src="https://unpkg.com/shin-monitor@1.3.0/dist/shin.umd.js"></script>
```
